                    ...
                    <div className="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <span className="select2 select2-container select2-container--default" dir="ltr" data-select2-id="2" style={{ width: "188px" }}>
                            <span className="selection">
                                <span className="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-qd66-container" aria-controls=''>
                    ...
                    <div className="row">
                                ...
                                <tbody>
                                    ...
                                    <tr className="">
                                        ...
                                        <td className="progress-bar-container">
                                            <div className="fit-progressbar fit-progressbar-bar star-progress-bar">
                                                <div className="fit-progressbar-background">
                                                    <span className="progress-fill" style={{ width: "2.2973%" }}></span>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr className="">
                                        ...
                                        <td className="progress-bar-container">
                                            <div className="fit-progressbar fit-progressbar-bar star-progress-bar">
                                                <div className="fit-progressbar-background">
                                                    <span className="progress-fill" style={{ width: "0" }}></span>
                                                </div>
                                            </div>
                                        </td>
                        ...
                        <div className="col-md-6">
                            <div className="ranking">
                                ...
                                <ul>
                                    <li>
                                        Seller communication level<span>5<span className="review-star rate-10 show-one"></span></span>
                                    </li>
                                    <li>
                                        Recommend to a friend<span>5<span className="review-star rate-10 show-one"></span></span>
                                    </li>
                                    <li>
                                        Service as described<span>4.9<span className="review-star rate-10 show-one"></span></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div className="d-flex">
                                ...
                                <div className="right">
                                    ...
                                    <div className="country d-flex align-items-center">
                                        <span>
                                            <img className="country-flag img-fluid" src="https://bootdey.com/img/Content/avatar/avatar6.png" alt='' />
                                        </span>
                                    ...
                                    <div className="response-item mt-4 d-flex">
                                        ...
                                        <div className="right">
                                            ...
                                            <div className="country d-flex align-items-center">
                                                <span>
                                                    <img className="country-flag img-fluid" src="https://bootdey.com/img/Content/avatar/avatar3.png" alt='' />
                                                </span>
                                                <div className="country-name font-accent">India</div>
                                            </div>
                                            <div className="review-description">
